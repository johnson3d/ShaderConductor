...
{
    float4 cbSimulationConstants_timeStep : packoffset(c0);
...
void comp_main()
{
    ...
    float _65 = -cbSimulationConstants_scene.wallStiffness.x;
    ...
    float2 _100 = _52 + ((((((_54 + (cbSimulationConstants_scene.planes[0u].xy * ((isnan(0.0f) ? _60 : (isnan(_60) ? 0.0f : min(_60, 0.0f))) * _65))) + (cbSimulationConstants_scene.planes[1u].xy * ((isnan(0.0f) ? _71 : (isnan(_71) ? 0.0f : min(_71, 0.0f))) * _65))) + (cbSimulationConstants_scene.planes[2u].xy * ((isnan(0.0f) ? _79 : (isnan(_79) ? 0.0f : min(_79, 0.0f))) * _65))) + (cbSimulationConstants_scene.planes[3u].xy * ((isnan(0.0f) ? _87 : (isnan(_87) ? 0.0f : min(_87, 0.0f))) * _65))) + cbSimulationConstants_scene.gravity.xy) * cbSimulationConstants_timeStep.x);
    particlesRW.Store2(gl_GlobalInvocationID.x * 16 + 0, asuint(_50 + (_100 * cbSimulationConstants_timeStep.x)));
